// Code generated by github.com/foae/dataloaden, DO NOT EDIT.
...
// UserLoaderLoadable defines the needed methods to interact with this entity.
type UserLoaderLoadable interface {
	Load(ctx context.Context, key string) (*User, error)
	LoadAll(ctx context.Context, keys []string) ([]*User, []error)
	LoadThunk(ctx context.Context, key string) func() (*User, error)
	LoadAllThunk(ctx context.Context, keys []string) func() ([]*User, []error)
...
func NewUserLoader(config UserLoaderConfig) UserLoaderLoadable {
	return &UserLoader{
		fetch:    config.Fetch,
		wait:     config.Wait,
...
func (b *userLoaderBatch) startTimer(l *UserLoader, ctx context.Context) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *userLoaderBatch) end(l *UserLoader, ctx context.Context) {
