...
func (b *userSliceLoaderBatch) keyIndex(l *UserSliceLoader, ctx context.Context, key int) int {
...
func (b *userSliceLoaderBatch) startTimer(l *UserSliceLoader, ctx context.Context) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *userSliceLoaderBatch) end(l *UserSliceLoader, ctx context.Context) {
